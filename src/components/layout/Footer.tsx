              ...
              <div className="container mx-auto px-4 text-center">
                <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 items-center">
                  <div className="flex justify-center lg:justify-start">
                    <Link href="/como-funciona" className="text-sm text-primary hover:underline flex items-center">
                   ...
                   <div className="flex justify-center">
                     <Link href="/normas" className="text-sm text-primary hover:underline flex items-center">

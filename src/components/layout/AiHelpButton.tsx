    ...
    return (
        <div className="fixed bottom-20 right-4 z-50 md:hidden flex flex-col items-center space-y-1">
            <Link 
                href={buttonLink}
                className={cn(
                    "bg-primary text-primary-foreground p-0 rounded-full shadow-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 flex items-center justify-center h-12 w-12"
                )}
